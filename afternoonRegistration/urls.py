"""afternoonRegistration URL Configuration
...
urlpatterns = [
    ...
    path('products/', general_views.view_products, name='view-product'),
    ...
    path('view-suppliers/', general_views.view_suppliers, name='view-suppliers'),
